...
local gui_main = require("modules/ctron_plugin/script/ui_main_screen")
local gui_settings = require("modules/ctron_plugin/script/ui_settings_screen")
local gui_job = require("modules/ctron_plugin/script/ui_job_screen")
local gui_cargo = require("modules/ctron_plugin/script/ui_cargo_screen")

--===========================================================================--
-- UI Handlers
--===========================================================================--

gui_handlers.gui_event_types = {
...
gui_handlers.on_player_created = function(event)
...
gui_handlers.on_gui_opened = function(event)
...
gui_handlers.on_gui_closed = function(event)
    local player = game.players[event.player_index]
...
function gui_handlers.gui_event(event)
    ...
    local player = game.get_player(event.player_index)
    if not player then return end
    local event_name = gui_handlers.gui_event_types[event.name]
